...
# --- PDF ENGINE (BUILT-IN FONTS - NO DOWNLOADS) ---
class ModernPDF(FPDF):
    def header(self):
        # 1. Main Title (Helvetica Bold)
        ...
        self.set_text_color(127, 140, 141) # Soft Grey
        self.cell(0, 10, 'Generated by Lecture-to-Notes Pro', 0, 0, 'R')
        
        # 3. Decorative Line
        self.ln(12)
        self.set_draw_color(233, 64, 87) # Pink Accent
    ...
    def chapter_title(self, title):
        ...
        # Encode to windows-1252 (Standard PDF encoding)
        try:
    ...
    def chapter_body(self, body):
        ...
        self.set_text_color(20, 20, 20) # Almost Black
        ...
        for line in body.split('\n'):
            ...
            # --- CLEANING (The Fix) ---
            # 1. Replace Unicode Bullet with Windows-1252 Bullet (Char 149)
            ...
            # 3. Handle Standard Lines
                ...
                self.set_font('Helvetica', '', 11)
                # Indent if it looks like a list
...
def convert_markdown_to_pdf(markdown_text):
    """Generates a Modern PDF using built-in fonts (No Download)"""
    pdf = ModernPDF()
    pdf.add_page()
    ...
    # --- GLOBAL CLEANUP (Prevents Crashes) ---
    # Remove Emojis that break standard fonts (VHS, Page, etc.)
